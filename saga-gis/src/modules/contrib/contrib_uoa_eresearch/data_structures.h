...
class grid_cellz : public grid_cell {
  public:
    ...
    grid_cellz(){}
    bool operator< (const grid_cellz& a) const { return ( _isnan(z) && !_isnan(a.z)) || z< a.z; }
    bool operator> (const grid_cellz& a) const { return (!_isnan(z) &&  _isnan(a.z)) || z> a.z; }
    bool operator>=(const grid_cellz& a) const { return ( _isnan(z) &&  _isnan(a.z)) || (!_isnan(z) &&  _isnan(a.z)) || z>=a.z; }
    bool operator<=(const grid_cellz& a) const { return ( _isnan(z) &&  _isnan(a.z)) || ( _isnan(z) && !_isnan(a.z)) || z<=a.z; }
    bool operator==(const grid_cellz& a) const { return ( _isnan(z) &&  _isnan(a.z)) || z==a.z; }
    bool operator!=(const grid_cellz& a) const { return !(_isnan(z) &&  _isnan(a.z)) && z!=a.z; }
};
...
class grid_cellzk : public grid_cellz<elev_t> {
  public:
    ...
    grid_cellzk(){}
    bool operator< (const grid_cellzk<elev_t>& a) const { return grid_cellz<elev_t>::z< a.z || ( _isnan(grid_cellz<elev_t>::z) && !_isnan(a.z)) || (grid_cellz<elev_t>::z==a.z && k<a.k) || (_isnan(grid_cellz<elev_t>::z) && _isnan(a.z) && k<a.k); }
    bool operator> (const grid_cellzk<elev_t>& a) const { return grid_cellz<elev_t>::z> a.z || (!_isnan(grid_cellz<elev_t>::z) &&  _isnan(a.z)) || (grid_cellz<elev_t>::z==a.z && k>a.k) || (_isnan(grid_cellz<elev_t>::z) && _isnan(a.z) && k>a.k); }
};
