...
//---------------------------------------------------------
#ifndef HEADER_INCLUDED__uniformerror_H
#define HEADER_INCLUDED__uniformerror_H
...
class Cuniformerror : public CSG_Module_Grid
{
public:
	Cuniformerror(void);

	virtual CSG_String			Get_MenuPath	(void)	{	return( _TL("Uniform Error Calculation") );	}
...
private:
	...
	// GRIDS
	CSG_Grid* Reference;
	CSG_Grid* UniformError;

	CSG_String Reference_InputPath;
	CSG_String UniformError_OutputPath;

	// Parameters
	double UniformErrorValue;
