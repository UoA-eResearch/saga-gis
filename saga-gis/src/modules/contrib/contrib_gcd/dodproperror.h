...
//---------------------------------------------------------
#ifndef HEADER_INCLUDED__dodproperror_H
#define HEADER_INCLUDED__dodproperror_H
...
class Cdodproperror : public CSG_Module_Grid
{
public:
	Cdodproperror(void);

	virtual CSG_String			Get_MenuPath	(void)	{	return( _TL("Propogated Error DoD") );	}
...
private:
	...
	CSG_String PropError_InputPath;
