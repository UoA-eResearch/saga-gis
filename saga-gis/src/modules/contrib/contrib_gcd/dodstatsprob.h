...
//---------------------------------------------------------
#ifndef HEADER_INCLUDED__dodstatsprob_H
#define HEADER_INCLUDED__dodstatsprob_H
...
class Cdodstatsprob : public CSG_Module_Grid
{
public:
	Cdodstatsprob(void);
...
private:
	...
	// GRIDS
	CSG_Grid* DoD_Input;
	CSG_Grid* DoD_Threshold;
	CSG_Grid* DoD_PropError;

	CSG_String DoD_InputPath;
	CSG_String DoD_ThresholdPath;
