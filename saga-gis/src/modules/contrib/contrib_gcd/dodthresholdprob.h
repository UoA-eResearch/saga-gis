...
//---------------------------------------------------------
#ifndef HEADER_INCLUDED__dodthresholdprob_H
#define HEADER_INCLUDED__dodthresholdprob_H
...
class Cdodthresholdprob : public CSG_Module_Grid
{
public:
	Cdodthresholdprob(void);

	virtual CSG_String			Get_MenuPath	(void)	{	return( _TL("Probabilistic Threshold") );	}
